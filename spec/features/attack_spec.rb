RSpec.feature 'attacking opponent' do
  ...
  scenario 'first attack shows player_one attacking player_two' do
    sign_in_and_play
    click_button "Attack!"
    expect(page).to have_content "player_one attacked player_two"
  end

  scenario 'first attack shows player two reduced hp' do
    sign_in_and_play
    click_button "Attack!"
  ...
  scenario 'second attack shows player_two attacking player_one' do
    sign_in_and_play
    click_button "Attack!"
    click_button "Attack!"
